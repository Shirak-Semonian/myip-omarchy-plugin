...
const nlParts = M.changeNotificationParts({ kind: "changed", from: { ip: "203.0.113.7" }, to: { ip: "198.51.100.7", country: "The Netherlands", countryCode: "NL" } })
...
eq(M.isLikelyIp("203.0.113"), false, "short ip rejected")
